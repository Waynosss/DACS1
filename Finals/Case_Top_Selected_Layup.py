...
This file runs the analyses on the selected layup for the top case.
...
stress_bottom = Mz * R / np.pi*(R**4 - (R-t)**4)/4  
stress_bottom= 820 #MPa
...
numPlys = len(layup)*2*n
thicknessLaminate = numPlys * t
weight = thicknessLaminate / 1000 * 450/1000 * 500/1000 * 1610
print(f"Num plys = {numPlys}")
print(f"Thickness = {thicknessLaminate} mm")
print(f"Weight = {weight} kg")
thicknessAluminium = 2.5 #mm
weightOfAluminium = thicknessAluminium / 1000 * 450/1000 * 500/1000 * 2770
